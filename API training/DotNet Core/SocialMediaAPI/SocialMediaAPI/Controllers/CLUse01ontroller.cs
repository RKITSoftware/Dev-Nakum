...
namespace SocialMediaAPI.Controllers
{
    ...
    [Route("api/users")]
    [ApiController]
    public class CLUse01ontroller : ControllerBase
    {
        ...
        public CLUse01ontroller(IUserService userService)
        {
        ...
        {
            objResponse = await _userService.GetUserDetails(HttpContext);
            return Ok(objResponse);
        }
        ...
        {
            objResponse = await _userService.GetFollowing(HttpContext);
            return Ok(objResponse);
        }
